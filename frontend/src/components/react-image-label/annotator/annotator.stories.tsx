...
import { Circle, Dot, Ellipse, Point, Polygon, Rectangle, Shape } from "../base/types"
...
const c = new Circle("c", [70, 90], 55, ["blueberry"], "rgba(0,0,0,0.4)")
const e = new Ellipse("e", [457, 114], 40, 80, ["raspberry"], 0, "#0004")
const d = new Dot("d", [123, 223], ["raspberry"], "rgba(0,0,0,0.4)")
const rawShapes = [
    {
        type: "rectangle",
        categories: ["class 3"],
...
export const ImageAnnotatorPrimary: FC = () => {
    ...
    const [shapes, setShapes] = React.useState<Shape[] | null>([r, p, c, e, d])
    const [dialog, setDialog] = React.useState<{
        show: boolean
        shape: Shape | undefined
    }>({ show: false, shape: undefined })
    ...
    return (
        <div>
            ...
            <button
                onClick={() => {
                    setShapes(annotator!.getShapes() || null)
                }}
            >
                Get shapes
            </button>
...
const Dialog = (props: DialogProps) => {
    ...
    return (
        <div className="dialog-bg" onClick={props.onClose}>
            ...
            >
                <button onClick={props.onEdit} style={{ background: "#36A9AE" }}>
                    edit
                </button>
                <button onClick={props.onDelete} style={{ background: "#F082AC" }}>
                    delete
                </button>
