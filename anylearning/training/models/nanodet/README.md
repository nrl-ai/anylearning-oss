...
The Android demo is maintained in the upstream
[demo_android_ncnn](https://github.com/RangiLyu/nanodet/tree/main/demo_android_ncnn)
directory.
...
C++ demo based on [ncnn](https://github.com/Tencent/ncnn) is available in the
vendored [demo_ncnn](deployment/demo_ncnn/README.md) directory.

### MNN demo

The MNN demo is maintained in the upstream
[demo_mnn](https://github.com/RangiLyu/nanodet/tree/main/demo_mnn) directory.

### OpenVINO demo

Inference using [OpenVINO](https://01.org/openvinotoolkit) is available in the
vendored [demo_openvino](deployment/demo_openvino/README.md) directory.
...
The [PyTorch inference notebook](deployment/demo/demo-inference-with-pytorch.ipynb)
demonstrates the native workflow.
...
Please refer to [demo_ncnn](deployment/demo_ncnn/README.md).

### OpenVINO

Please refer to [demo_openvino](deployment/demo_openvino/README.md).
