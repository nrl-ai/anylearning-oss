...
setup(
    ...
    description="Offline-first no-code AI labeling and local model training",
    ...
    project_urls={
        "Documentation": "https://anylearning-oss.nrl.ai",
        "Issues": "https://github.com/nrl-ai/anylearning-oss/issues",
        "Source": "https://github.com/nrl-ai/anylearning-oss",
    },
    install_requires=get_install_requires(),
    license="Apache-2.0",
    license_files=["LICENSE", "LICENSES.md", "MODEL_LICENCES.md", "NOTICE"],
    keywords=[
        "annotation",
        "computer-vision",
        "machine-learning",
