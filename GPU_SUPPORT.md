...
on an RTX 3080.) Only the _packaged Windows installer_ is a distinct,
...
step is needed just to pin a _different_ CUDA version.
...
> 13 wheels ship under _different_ package names (`nvidia-*-cu12` vs
