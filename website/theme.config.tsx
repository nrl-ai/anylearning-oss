...
const config: DocsThemeConfig = {
  ...
  project: {
    link: "https://anylearning-oss.nrl.ai/",
    icon: "",
  },
  ...
  banner: {
    ...
    text: (
      <a href="/docs/tabular-ai">
        New in AnyLearning 0.26.3: large-table Tabular AI, Text AI and safe Hugging Face imports. Explore the guide →
      </a>
    ),
  },
  editLink: {
  ...
  footer: {
    text: (
      <div className="flex w-full flex-col items-center gap-1 sm:items-start">
        ...
        >
          Developed by <span className="font-medium">Neural Research Lab</span>.
        </a>
        <p className="text-xs">
