...
import { Slideshow } from "../components/screenshot/slideshow";
 ...
 * laptop mockup. AnyLearning instead shows the real workflow immediately,
 * followed by a labeller visitors can actually use before downloading it.
 */
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-background text-foreground">
        ...
        {/* --- Hero ------------------------------------------------------- */}
        <header className="mx-auto grid w-full max-w-6xl items-center gap-12 px-6 pt-16 pb-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] lg:pt-20 lg:pb-14">
          <div>
            <p className="t-eyebrow mb-4">Offline computer vision</p>
            <h1 className="t-display max-w-3xl text-4xl font-semibold sm:text-5xl lg:text-[3.35rem]">
        ...
        >
          <div className="mt-10 grid gap-px overflow-hidden rounded-xl border border-line bg-line sm:grid-cols-3">
            {[
              ...
              [
                "No account",
                "Nothing to sign into and no activation key. Install it and start working.",
              ],
              [
                "No running cost",
