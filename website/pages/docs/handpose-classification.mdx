...
**Trial Dataset:** We prepared a trial dataset for you to get started. You can download it from [Hugging Face](https://huggingface.co/datasets/nrl-ai/anylearning-data/tree/main/american_sign_language).
...
![All training](/handpose_classification/05_all_trainings.png)
...
![Data Preprocessing](/handpose_classification/08_try_model_result.png)
