...
![Data Preprocessing](/image_classification/01_create_project.png)
...
![Data Preprocessing](/image_classification/02_create_classes.png)
...
![Data Preprocessing](/image_classification/03_folder_structure.png)
...
**Trial Dataset:** We prepared a trial dataset for you to get started. You can download it from [Hugging Face](https://huggingface.co/datasets/nrl-ai/anylearning-data/tree/main/zhanglabdata_chest_xray).
...
![Data Preprocessing](/image_classification/04_create_new_training.png)

**Monitor Training Progress:**

- View all training sessions in the "Training" tab
- Click on any session to see detailed information
![Data Preprocessing](/image_classification/05_all_trainings.png)
...
![Data Preprocessing](/image_classification/06_view_training_detail.png)
...
![Data Preprocessing](/image_classification/07_try_model.png)

The model will display its prediction along with confidence scores for each class:
![Data Preprocessing](/image_classification/08_view_model_prediction.png)
