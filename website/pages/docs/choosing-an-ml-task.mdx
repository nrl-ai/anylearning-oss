...
```mermaid
flowchart TD
  accTitle: Choose the right machine-learning task
  accDescr: Decision tree that maps tabular, text and image data to the machine-learning tasks available in AnyLearning.
