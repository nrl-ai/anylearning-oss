...
export const shots = [
  ...
  },
  {
    ...
    notes: [
      { type: "label", x: 400, y: 300, text: "Bigger variants are slower but usually more accurate" },
    ],
  },
  {
  ...
  },
  {
    ...
    path: "/projects/models",
    requiresModel: true,
    steps: [{ eval: `document.querySelector('[aria-label="Download model"]')?.click(); true`, wait: 900 }],
