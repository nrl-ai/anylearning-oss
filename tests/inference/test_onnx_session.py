...
@pytest.mark.parametrize("enable_mem_pattern", [False, True])
def test_session_options_apply_explicit_memory_policy(
    ...
    assert options.enable_mem_pattern is enable_mem_pattern
